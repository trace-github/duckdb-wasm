// duckdb_evalexpr_rust — WASM-compatible version
// Based on evalexpr_rhai by Rusty Conover <rusty@query.farm>
// Licensed under the MIT License
//
// Stripped rhai-fs, rhai-rand, rhai-sci for WASM compatibility.
// Retains: rhai core + rhai-url + serde.
